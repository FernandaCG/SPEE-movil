...
public class ReportesAdapter extends RecyclerView.Adapter<ReportesAdapter.ViewHolder> {
    ...
    @Override
    public ReportesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View itemView = LayoutInflater.
                from(parent.getContext()).
                inflate(R.layout.item_reporte, parent, false);

        return new ReportesAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ReportesAdapter.ViewHolder viewHolder, int position) {
